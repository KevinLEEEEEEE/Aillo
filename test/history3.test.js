import history from '../src/js/myCanvas/components/history3';

const assert = require('assert');

describe('history with private', () => {
  describe('do', () => {
    it('less than max steps', () => {
      ...
      assert.deepEqual(myHistory.getHistoryArray(), [1, 2, 3]);
    });
    ...
    it('equals max steps', () => {
      ...
      assert.deepEqual(myHistory.getHistoryArray(), [1, 2, 3, 4, 5]);
    });
    ...
    it('more than max steps', () => {
      ...
      assert.deepEqual(myHistory.getHistoryArray(), [6, 7, 3, 4, 5]);
    });
  });
  ...
  describe('undo', () => {
    ...
    it('less with complex undo', () => {
      ...
      assert.deepEqual(myHistory.getHistoryArray(), [1, 2, 3, 4]);
      ...
      assert.deepEqual(myHistory.getHistoryArray(), [1, 2, 5, 6, 7]);
    });
    ...
    it('more with complex undo', () => {
      ...
      assert.deepEqual(myHistory.getHistoryArray(), [6, 2, 3, 4, 5]);
      ...
      assert.deepEqual(myHistory.getHistoryArray(), [8, 9, 3, 4, 7]);
    });
  });
  ...
  describe('redo', () => {
    ...
    it('more with complex redo', () => {
      ...
      assert.deepEqual(myHistory.getHistoryArray(), [7, 2, 3, 4, 5]);
    });
  });
  ...
  describe('can redo', () => {
    ...
    it('redo before undo', () => {
      ...
      assert.deepEqual(myHistory.getHistoryArray(), [1]);
  ...
  describe('can undo', () => {
    it('undo with nothing', () => {
      ...
      assert.deepEqual(myHistory.getHistoryArray(), []);
    ...
    it('undo more than do', () => {
      ...
      assert.deepEqual(myHistory.getHistoryArray(), [1, 2]);
